      ...
      <div className='main'>
			...
			<div className='title'>
				<div className='title-container'>
					<h2>MPC Simulator</h2>
					adapted from an original app created by <a href="http://lewislehe.com">Lewis Lehe</a> (of <a href="http://setosa.io">Setosa</a>)
				</div>
			</div>
			<div className='flex-container-column'>
				<div className="content">
					...
					<div className='flex-container-row legend'>
						<div>			
							<p>With the <span className="blue">blue</span> dot, control <KK S="i" col={CC.i}/> to stabilize <KK S="\pi" col={CC.π}/> and <KK S="u" col={CC.u}/>. 
							
							When <KK S="r<\bar{r}" col={CC.r}/>, <KK S="u" col={CC.u}/> falls; 	when <KK S="r>\bar{r}" col={CC.r}/>, <KK S="u" col={CC.u}/> rises. When <KK S="u<\bar{u}" col={CC.u}/>, <KK S="\pi" col={CC.π}/> rises; when <KK S="u>\bar{u}" col={CC.u}/>, <KK S="\pi" col={CC.π}/> falls.<br/> You fail if <KK S="u" col={CC.u}/> or <KK S="\pi" col={CC.π}/> gets too high.
							</p>
						</div>
						<div>
							<ul>
